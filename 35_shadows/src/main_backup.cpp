...
int main()
{
	...
	floor_model_matrix = glm::translate(floor_model_matrix, glm::vec3(0.0f, 0.0001f, 0.0f));
	...
	plate_model_matrix = glm::translate(plate_model_matrix, glm::vec3(0.0f, 0.5f, 0.0f));
	...
	while(!glfwWindowShouldClose(window)) {
		...
		glUniform3f(glGetUniformLocation(objectshader.program, "LightDirection"), 0.0f, 2.0f, 0.0f);
		glUniform3f(glGetUniformLocation(objectshader.program, "LightAmbient"), 0.3f, 0.3f, 0.3f);
		glUniform3f(glGetUniformLocation(objectshader.program, "LightDiffuse"), 0.5f, 0.5f, 0.5f);
