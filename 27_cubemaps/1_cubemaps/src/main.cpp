 ...
 * Breif Description : basic cube maps
 * Detailed Description : optimizations such as face culling and depth tests have yet to be added. The cubemap has to move with the camera - yet to be implemented.
 *****************************************************************************/
#define GLEW_STATIC
#include <GL/glew.h>
