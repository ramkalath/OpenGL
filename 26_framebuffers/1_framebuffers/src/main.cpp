 ...
 * Detailed Description : Creates a framebuffer on a 2D rectangular plate rendered without the z axis values. Checkout the 2_framebuffer. That my own version.
 *****************************************************************************/
#include <iostream>
#include <string>
