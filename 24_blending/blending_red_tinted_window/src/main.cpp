 ...
 * Breif Description : blending
 * Detailed Description : blending with red tinted windows
 *****************************************************************************/
#define GLEW_STATIC
#include <GL/glew.h>
...
int main()
{
	...
	model_window = glm::translate(model_window, glm::vec3(-1.0f, 0.0f, 2.0f));

	glm::mat4 model_window1 = glm::mat4(1.0f);
	model_window1 = glm::translate(model_window1, glm::vec3(-0.7f, 0.0f, 2.3f));

	camera_pos = glm::vec3(0.0f, 1.0f, 4.0f); 
