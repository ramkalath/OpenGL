 ...
 * Breif Description : normals visualization
 * Detailed Description : assimp model loading with normals visualization
 *****************************************************************************/
...
int main()
{
	...
	//Geomshader normalsshader("./shaders/vertex_shader.vert", "./shaders/geometry_shader.geom", "./shaders/fragment_shader.frag");
